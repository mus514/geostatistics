...
sf::st_write(poly_classified, "data-processed/potential_sites_NM/potential_sites_NM.shp",
             append = FALSE)
sf::st_write(peeori_classified, "data-processed/IEQM_permanentplots_NM/IEQM_permanentplots_NM.shp", append = FALSE)
